...
public class Loom : MonoBehaviour
{
	...
	void Update()
	{
		// if (Time.deltaTime > 0.033f && XDLogger.CurLogicFrameId != -1)
		// {
		// 	XDLogger.Instance.LFight("Loom-update", $"Time.deltaTime = {Time.deltaTime}");
		// }
        ...
        foreach (var delayed in toBeDelayed)
        {
