...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp8(UnityEngine.Transform p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(UnityEngine.Transform p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.Transform, int>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Transform>))
			{
			    return new System.Action<UnityEngine.Transform>(__Gen_Delegate_Imp9);
			}
