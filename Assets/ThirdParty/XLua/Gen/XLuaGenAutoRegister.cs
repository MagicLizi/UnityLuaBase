...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(UnityEventBaseEx), UnityEventBaseExWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate void __GEN_DELEGATE0( UnityEngine.Events.UnityEventBase unityEventBase);
		
		delegate void __GEN_DELEGATE1( UnityEngine.Events.UnityEventBase unityEventBase);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.Events.UnityEventBase), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE0(UnityEventBaseEx.ReleaseUnusedListeners)
				  ...
				  new __GEN_DELEGATE1(UnityEventBaseEx.ReleaseUnusedListeners)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
