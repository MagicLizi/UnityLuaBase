...
namespace XLua.CSObjectWrap
{
    ...
    public class LoggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DInfo", _m_DInfo_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DInfo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _devInfo = LuaAPI.lua_tostring(L, 1);
                    
                    Logger.DInfo( _devInfo );
